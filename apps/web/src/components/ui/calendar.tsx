    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size) p-0 select-none transition-none active:not-aria-[haspopup]:translate-y-0 aria-disabled:opacity-50",
...
function CalendarRoot({ rootRef, ...props }: React.ComponentProps<typeof Root>) {
